...
We're not giving you a solution for your particular problem. But we provide you a simple framework you can use to define a document model, plus [building blocks](http://github.com/substance/composer) to build your own editor for manipulating those documents.
...
Here are some less obvious, but perfectly valid applications of the Substance Document Model.
...
All this can take place in the browser. At the end of the day


Micropage
--------

Say you want to offer your customer an easy way to build micropages, based on a template. He just needs to fill out
